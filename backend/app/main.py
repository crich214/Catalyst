...
def system_health():
    # Lightweight health profile for Step 5. Later this will ping each connector.
    return {
        "overall_health": 88,
        "feeds": [
            {"name": "Market Data", "status": "Live", "score": 90, "detail": "yfinance connector enabled"},
            {"name": "Ticker Alias Map", "status": "Live", "score": 100, "detail": "Alias normalization enabled"},
            {"name": "Fallback Profiles", "status": "Live", "score": 85, "detail": "Fallback layer enabled for core names"},
            {"name": "Insider Data", "status": "Placeholder", "score": 35, "detail": "FMP/OpenInsider connector pending"},
            {"name": "Congress Data", "status": "Placeholder", "score": 25, "detail": "Quiver/FMP connector pending"},
            {"name": "Macro Data", "status": "Live", "score": 85, "detail": "FRED public CSV connector enabled"},
            {"name": "AI Committee", "status": "Pending", "score": 20, "detail": "OpenAI memo engine pending"}
        ],
